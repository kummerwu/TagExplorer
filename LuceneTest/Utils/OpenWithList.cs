...
namespace TagExplorer.Utils
{
    ...
    {
        public OpenWithList(string ext)
        {
            RecommendedPrograms(ext);
            foreach(string progid in progs)
            {
                cmds.Add(GetRegisteredApplication(progid));
            }
        ...
        private void RecommendedPrograms(string ext)
        {
